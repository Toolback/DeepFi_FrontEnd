...
import { ChevronDown } from './utils/chevron-down';
import { useClickAway } from './utils/use-click-away';
import { useLockBodyScroll } from './utils/use-lock-body-scroll';
import { coinList } from './utils/coin-list';
// dynamic import
const CoinSelectView = dynamic(
  () => import('./coin-select-view')
);
      ...
      >
        ...
        <div className="flex flex-1 flex-col text-right">
          <input
            ...
            className="w-full rounded-tr-lg rounded-br-lg border-0 pb-0.5 text-right text-lg outline-none focus:ring-0 bg-primary-black bg-opacity-5"
            {...rest}
          />

    ...
    <div className="relative pb-4 sm:py-8">
      ...
      <div className="mx-auto max-w-7xl bg-transparent lg:px-8">
        <div className="lg:grid lg:grid-cols-12">
          ...
          <div className="relative border border-white border-opacity-10 bg-purple-500 bg-opacity-10 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">

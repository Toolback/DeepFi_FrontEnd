  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      let res =
      {
        ...
        userClaimable: connected == true ? (await getVaultUserClaimable(vault.address, stateAppData.userAddress)).toString() + "" : "N/a",
                  ...
                  <div className='flex justify-center items-center gap-10 h-full'>
                    ...
                    <div className='flex-col'>
                      <div className="text-center ">
                        ...
                        <h4 className='text-sm text-gray-300'>Your Deposit</h4>
                      </div>
                      <div className="pt-3 text-center">
                        <p className='text-lg font-bold tracking-tight text-white'>N/a </p>
                    ...
                    <div className='flex-col items-stretch'>
                      ...
                      <div className="pt-3 text-center">
                        <p className='text-lg font-bold tracking-tight text-white'>{stats.tvl}</p>
                        <h4 className='text-sm text-gray-300'>Available</h4>
                      </div>
                    </div>
                  </div>
                </div>

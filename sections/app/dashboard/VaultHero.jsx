...
import { slideIn, staggerContainer, textVariant, floatingAnimation } from 'utils/motion';
          ...
          <div className="mx-auto max-w-7xl bg-transparent lg:px-8">
            <div className="lg:grid lg:grid-cols-12">
              ...
              <motion.div
                ...
                className="relative border border-white border-opacity-10 bg-purple-900/10 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl shadow-2xl"
              >
